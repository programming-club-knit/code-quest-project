...
const LoginPage = () => {
    ...
    return (
        <div className="font-sans min-h-screen bg-[#f3f3f3] flex flex-col items-center py-4 px-2 sm:px-4">
            ...
            {/* Top Navbar / Header */}
            <div className="w-full max-w-[1000px] flex flex-col sm:flex-row items-center sm:items-end justify-between border-b gap-4 sm:gap-0 border-[#b9b9b9] pb-2 mb-8">
                {/* Left side: Logos */}
            ...
            <div className="w-full max-w-[450px] bg-white border border-[#b9b9b9] text-[13px] shadow-sm tracking-wide rounded-sm">
                ...
                <div className="p-4 px-3 sm:px-6 text-[#222]">
                    <form onSubmit={handleLogin}>
                        <div className="flex flex-col sm:flex-row mb-3 sm:mb-2 items-start sm:items-center">
                            <div className="sm:w-[40%] sm:text-right sm:pr-4 font-bold mb-1 sm:mb-0">
                        ...
                        <div className="flex flex-col sm:flex-row mb-3 mt-4 sm:mt-0">
                            <div className="hidden sm:block sm:w-[40%]"></div>
                            <div className="w-full sm:w-[60%] flex items-center gap-[6px]">
                                <input
                                    type="checkbox"
                                    id="remember"
                                    className="m-0 border-[#ccc] cursor-pointer"
                                />
                                <label htmlFor="remember" className="text-[12px] cursor-pointer">Remember me for a month</label>
                            </div>
                        </div>
