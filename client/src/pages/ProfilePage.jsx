            ...
            <div className="w-full max-w-[1000px] bg-white border border-[#b9b9b9] text-[13px] shadow-sm rounded-sm">
                <div className="p-6 text-[#333]">
                    <div className="flex justify-between items-start border-b border-[#eee] pb-4 mb-4">
                        <div>
                            <h1 className="text-2xl font-semibold mb-1" style={{ color: teamData.isVerified ? '#00a900' : '#888' }}>
                                {teamData.teamName}
                            </h1>
                        ...
                        <div className="text-right text-[12px] text-[#888]">
                            <img src={`https://api.dicebear.com/7.x/identicon/svg?seed=${teamData.teamName}&backgroundColor=e1e1e1`} alt="avatar" className="w-16 h-16 border border-[#b9b9b9] p-1" />
                        </div>
                    </div>
                    ...
                    <div className="flex gap-16">
                        ...
                        <div className="flex-1">
                            ...
                            <table className="text-[13px]">
                                <tbody>
                                    <tr>
                                        <td className="py-1 text-[#888] pr-4">Name:</td>
                                        <td className="py-1 font-semibold">{teamData.teamLeaderName}</td>
                                    </tr>
                                    <tr>
                                        <td className="py-1 text-[#888] pr-4">Email:</td>
                                        <td className="py-1">{teamData.teamLeaderEmail}</td>
                                    </tr>
                                    <tr>
                                        <td className="py-1 text-[#888] pr-4">Branch:</td>
                                        <td className="py-1">{teamData.branch}</td>
                                    </tr>
                                    <tr>
                                        <td className="py-1 text-[#888] pr-4">Year:</td>
                                        <td className="py-1">{teamData.year}</td>
                                    </tr>
                                    <tr>
                                        <td className="py-1 text-[#888] pr-4">Roll No:</td>
                                        <td className="py-1">{teamData.rollNo}</td>
                                    </tr>
                                    <tr>
                                        <td className="py-1 text-[#888] pr-4">Mobile:</td>
                                        <td className="py-1">{teamData.mobileNo}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
